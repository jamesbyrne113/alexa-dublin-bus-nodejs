(function() {
  var Promise, buildFilters, dataTrans, debug, getKey, scanFilterFunc, _;
  ...
  module.exports.updateItem = function(params, obj, options, callback, keySchema) {
    var awsParams, expressionAttributeNames, expressionAttributeValues, i, key, updateExpression, _i, _len, _ref;
    key = getKey(params, keySchema);
